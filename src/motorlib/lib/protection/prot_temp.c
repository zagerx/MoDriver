...
//  */
// bool check_temp(struct motor *motor, uint32_t *fault_bit)
// {
...
//  * @param fault_bit 故障位
//  */
// void enter_temp_fault(struct motor *motor, uint32_t fault_bit)
// {
// 	(void)fault_bit;
...
//  * @param motor 电机实例
//  */
// void recover_temp_fault(struct motor *motor)
// {
// 	// 温度恢复：回到空闲状态
