...
params = [
    (0x2009, 0x01, "direction", "float", 0.0),
    (0x2009, 0x02, "encoder_resolution", "uint16", 0x0000),
    (0x2009, 0x03, "encoder_offset", "uint16", 0x0000),
    (0x2009, 0x04, "encoder_offset_frac", "float", 0.0),
    (0x2009, 0x05, "A_chn_offset", "uint16", 0x0000),
    (0x2009, 0x06, "B_chn_offset", "uint16", 0x0000),
    (0x2009, 0x07, "C_chn_offset", "uint16", 0x0000),
    (0x2009, 0x08, "gain_phase", "float", 0.006855),
    (0x2009, 0x09, "gain_i_bus", "float", 0.0),
    (0x2009, 0x0A, "gain_v_bus", "float", 0.01059),
    (0x2009, 0x0B, "acc_max", "float", 1800.0),
    (0x2009, 0x0C, "vmax", "float", 15000.0),
    (0x2009, 0x0D, "D_kp", "float", 0.1),
    (0x2009, 0x0E, "D_ki", "float", 800.0),
    (0x2009, 0x0F, "D_kd", "float", 0.0),
    (0x2009, 0x10, "D_limit", "float", 13.0),
    (0x2009, 0x11, "Q_kp", "float", 0.1),
    (0x2009, 0x12, "Q_ki", "float", 800.0),
    (0x2009, 0x13, "Q_kd", "float", 0.0),
    (0x2009, 0x14, "Q_limit", "float", 13.0),
    (0x2009, 0x15, "vel_kp", "float", 0.002),
    (0x2009, 0x16, "vel_ki", "float", 0.2),
    (0x2009, 0x17, "vel_kd", "float", 0.0),
    (0x2009, 0x18, "vel_limit", "float", 10.0),
    (0x2009, 0x19, "pos_kp", "float", 400.0),
    (0x2009, 0x1A, "pos_ki", "float", 4000.0),
    (0x2009, 0x1B, "pos_kd", "float", 0.0),
    (0x2009, 0x1C, "pos_limit", "float", 15000.0),
    (0x2009, 0x1D, "rs", "float", 0.0),
    (0x2009, 0x1E, "ls", "float", 0.0),
    (0x2009, 0x1F, "pole_pairs", "float", 0.0),
    (0x2009, 0x20, "wheel_radius", "float", 17.5),
    (0x2009, 0x21, "gear_ratio", "float", 1.0),
